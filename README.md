# genpark-unified-streaming-ai-gateway-fallback-router-skill
...
> **GenPark AI Agent Skill** -- Unified streaming AI gateway with automated provider fallback & schema stream (Vercel style)
